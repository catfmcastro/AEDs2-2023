...
No *inserir2(No *raiz, Jogador *jogador)
{
    ...
    else if (raiz->elemento != NULL && strcmp(jogador->nome, raiz->elemento->nome) < 0)
    {
        comp += 2;
...
void pesquisar2(No *raiz, char *nome)
{
    if (raiz == NULL)
    {
        comp++;
    ...
    else if (raiz->elemento != NULL && strcmp(nome, raiz->elemento->nome) == 0)
    {
        comp += 2;
        printf(" SIM\n");
    }
    else if (raiz->elemento != NULL && strcmp(nome, raiz->elemento->nome) < 0)
    {
        comp += 3;
        printf(" esq");
        pesquisar2(raiz->esq, nome);
    }
    else
    {
        comp += 3;
        printf(" dir");
        pesquisar2(raiz->dir, nome);
    }
}
