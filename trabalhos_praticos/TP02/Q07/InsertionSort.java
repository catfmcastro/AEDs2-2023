...
// ler uma serie de ids dos jogadores e imprimi-los na saida em ordenados pelo ano de nascimento, utilizando o insertion sort
...
public class InsertionSort {
    ...
    // SELECTION SORT pelo ano de nascimento do jogador
    public static void sort(Jogador[] array, int tam) {
        for (int i = 1; i < tam; i++) {
            ...
            while ((j >= 0) && (array[j].getAnoNascimento() > tmp.getAnoNascimento() || compNome(array[j], tmp))) {
                array[j + 1] = array[j];
                j--;
                mov++;
            }
