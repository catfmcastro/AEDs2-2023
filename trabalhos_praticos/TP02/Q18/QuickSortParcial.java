...
// ler uma serie de ids dos jogadores e imprimi-los na saida em ordenados pelo estadoNascimento, utilizando o quick sort parcial
// package Q18;
...
class QuickSortParcial {
    ...
    public static void criarLog(long tempo) throws IOException {
        File logs = new File("803531_quicksort.txt");
    ...
    // QUICK SORT PARCIAL pelo estado nascimento
    ...
    public static void main(String[] args) {
        ...
        int tam = 0;
        int k = 10; // imprimir os 10 menores
