...
// shell sort em C, ordenando jogadores pelo peso
...
void criaLog()
{
    const char *nomeArquivo = "803531_shellsort.txt";
    char content[100];
...
// compara os pesos de dois jogadores
bool compPeso(Jogador i, Jogador tmp)
{
    bool resp;
    comp++;
