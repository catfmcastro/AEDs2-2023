...
public class MergesortInv {
    ...
    static void intercalar(int esq, int meio, int dir, int[] array) {
        ...
        arrayEsq[nEsq] = arrayDir[nDir] = -0x7FFFFFFF; // a sentinela é o menor número possível
    ...
    public static void main (String[] args){
        ...
        int[] array = {3, 5, 6, 9, 1, 2, 5, 4, 6, 6, 7, 0};
